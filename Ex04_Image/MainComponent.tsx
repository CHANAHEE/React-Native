...
export default class MainComponent extends Component{
    ...
    state: React.ComponentState = {
        ...
        imgArr: [
            ...
            {uri:'https://cdn.pixabay.com/photo/2023/05/20/10/11/lemon-8006238__340.jpg'},
            {uri:'https://cdn.pixabay.com/photo/2023/04/11/04/59/bird-7915772__340.jpg'},
            {uri:'https://cdn.pixabay.com/photo/2023/05/18/08/13/bear-8001665__340.png'},
        ],
        imgNum: 0
    }
    ...
    render(): JSX.Element {
        return (
            ...
            // 5. 배경 이미지 - CSS 의 background-image 은 없음. 대신 ImageBackground 컴포넌트 사용 
            <View style={{flex:1}}>
                <ImageBackground source={this.state.imgArr[3]} style={{width: '100%', height: '100%'}}>
