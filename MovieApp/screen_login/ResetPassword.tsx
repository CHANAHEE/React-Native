        ...
        <View style={style.root}>
            ...
            <View style={style.content}>
                ...
                <View style={style.tabContainer}>
                    {
                        tabs.map((value,index)=>{
                            return(
                                <TabComponent label={tabs[index]} selected={index == tabIndex} onPress={()=>setTabIndex(index)} key={index}></TabComponent>
                            )
                        })
                    }
                </View>
                ...
                <View style={{width: '100%', margin: 16}}>
                    <Button title='전송' onPress={()=>Alert.alert('임시비밀번호가 발송되었습니다.','로그인 후 정보수정을 통해 안전한 비밀번호로 변경해주시기 바랍니다.')}></Button>
                </View>
            </View>
